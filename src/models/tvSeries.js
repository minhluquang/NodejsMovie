...
module.exports = (sequelize, DataTypes) => {
  class tvSeries extends Model {
    ...
    static associate(models) {
      ...
      tvSeries.hasMany(models.TVSeriesProductionCompany, {
        foreignKey: "tv_series_id",
        as: "production_companies",
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
      });
      tvSeries.hasMany(models.TVSeriesImage, {
        foreignKey: "tv_series_id",
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
      });
      tvSeries.hasMany(models.TVSeriesVideo, {
        foreignKey: "tv_series_id",
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
      });
      tvSeries.hasMany(models.RatingTVSeries, {
        foreignKey: "tv_series_id",
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
      });
      tvSeries.hasMany(models.FavoriteTVSeries, {
        foreignKey: "tv_series_id",
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
      });
